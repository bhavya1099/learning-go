...
// Ensure you also include a go.mod file in your project root if it's not already there:
// module CountingSort

// go 1.15

// This module declaration will help resolve the "cannot find main module" error.
